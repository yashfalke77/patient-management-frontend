  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" size="icon" className="rounded-full">
          <Avatar>
            ...
            <AvatarFallback className="text-white bg-dark-400 border border-dark-500">USR</AvatarFallback>
          </Avatar>
        </Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent className="w-32 bg-dark-400 border-none rounded-xl overflow-hidden">
        ...
        <DropdownMenuGroup>
          <DropdownMenuItem onClick={onLogout} className="text-red-500 hover:bg-dark-500 focus:bg-dark-500 focus:text-red-500 cursor-pointer rounded-lg">
            Log out
          </DropdownMenuItem>
        </DropdownMenuGroup>
      </DropdownMenuContent>
